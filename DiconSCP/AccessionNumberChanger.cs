...
namespace DicomSCPService
{
    public class AccessionNumberChanger
    {
        ...
        public DICOMObject SetAccessionNumber(DICOMObject dcmFile)
        {
            ...
            logger.Info(counter);
            var accNumberElement = file.Elements.FirstOrDefault(e => e.Tag.CompleteID == "00800050");
            var instituteNameElement = file.Elements.FirstOrDefault(e => e.Tag.CompleteID == "00800080");
